export default function Service() {
    return (
        <div id="service">
        <section  className="bg-white py-16 pb-6">
            <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                <div className="container mx-auto px-6 p-6 bg-white">
                    <div className="mb-16 text-center">
                        <h4 className="text-base text-red-200 font-semibold tracking-wide uppercase">Nuestros</h4>
                        <p className="mt-2 text-5xl lg:text-7xl font-bold tracking-tight text-gray-900">Servicios</p>
                    </div> 
